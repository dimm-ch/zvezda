...
auto AD9208::set_mode(size_t app_mode, size_t dcm) -> void
{
    ...
    auto filter1 = (decimate == 2) ? 0b011 : (decimate == 4) ? 0b000
        : (decimate == 6)                                    ? 0b100
        : (decimate == 8)                                    ? 0b001
        : (decimate == 12)                                   ? 0b101
        : (decimate == 16)                                   ? 0b010
        : (decimate == 24)                                   ? 0b110
                                                             : 0b111;
    auto filter2 = (decimate == 3) ? 0b0111 : (decimate == 10) ? 0b0010
        : (decimate == 15)                                     ? 0b1000
        : (decimate == 20)                                     ? 0b0011
        : (decimate == 30)                                     ? 0b1001
        : (decimate == 40)                                     ? 0b0100
...
auto AD9208::set_jesd(double lane_rate_max) -> bool
{
    ...
    jesd_F = (jesd_M == 1) ? 2 : (jesd_M == 2) ? (jesd_L == 1) ? 4 : 2
        : (jesd_M == 4)                        ? (jesd_L == 1) ? 8 : (jesd_L == 2) ? 4
                                                                                   : 2
        : (jesd_M == 8)                        ? (jesd_L == 1) ? 16 : (jesd_L == 2) ? 8
                                   : (jesd_L == 4)                                  ? 4
                                                                                    : 2
                                               : 0;
...
auto AD9208::set_fast_detect(size_t channel, bool enable, double upper, double lower, uint16_t time) -> void
{
    ...
    upper = upper < -78 ? -78 : upper > 0 ? 0
                                          : upper;
    lower = lower < -78 ? -78 : lower > 0 ? 0
                                          : lower;
