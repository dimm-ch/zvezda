...
S32 WorkMode(bool& stop)
{
    ...
    case 5:
        ...
        break;
    case 6:
        WorkMode6(stop); // stop глубоко и не прокинут
        break;
    case 7:
        WorkMode7(stop);
        break;
    case 8:
        WorkMode8(stop); // stop глубоко и не прокинут
        break;
    }
    return 0;
}
...
S32 WorkMode8(bool& stop)
{
    ...
    BRDC_printf(_BRDC("Press any key to stop ...\n"));
    PrepareStart();
    SdramLikeFifoOutputCycleDMA(stop);
...
S32 SdramSetParam(int idxDac)
{
    ...
    if (rSdramConfig.PrimWidth == 32) {
        memSizew = (U32)(g_aDac[idxDac].outBufSizeb >> 1);
