...
public:
	...
	// Создание таблицы
    virtual int CreateTable(const char *pColumnName[], unsigned nCount) = 0;
    virtual int CreateTable(const std::vector<std::string>& columns) = 0;
...
using table_t = std::shared_ptr<TableEngine>;
