...
enum {
    ...
    BRDctrl_SYNC_SECTION = BRD_SECTIONSIZE * 28, // Synchronizator control parameters
    BRDctrl_JESD_SECTION = BRD_SECTIONSIZE * 29, // JESD control parameters
	BRDctrl_FM402S = BRD_SECTIONSIZE*30,	// fm40Xs control parameters
    BRDctrl_ILLEGAL
};
...
//
enum {
    BRDctrl_GETTRACETEXT = BRDctrl_COMMON + 0, // Получить буфер трассировки в виде текста
    BRDctrl_GETTRACEPARAM = BRDctrl_COMMON + 1, // Получить буфер трассировки в виде структуры
};
