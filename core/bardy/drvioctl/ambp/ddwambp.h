...
//
//	Copyright (c) 2004-2013, Instrumental Systems,Corp.
//  Written by Dorokhin Andrey
//
//  History:
//  05-10-04 - builded
//  21-06-06 - add Local Bus read/write ioctls
//  16-01-13 - support 64-bit driver
//
//*******************************************************************
...
#ifdef _WIN64
#define AmbDeviceName L"wambp"
#else
#ifdef __linux__
#define AmbDeviceName "ambp"
#else
#define AmbDeviceName "wambp"
#endif
#endif
...
#define IOCTL_AMB_LOAD_PLD				AMB_MAKE_IOCTL(16)
...
#define IOCTL_AMB_LOAD_PLD_EEPROM		AMB_MAKE_IOCTL(31)
...
typedef struct _AMB_BUF_REG {
	...
	PVOID	pBuffer;		// IN
	ULONG	BufferSize;		// IN
} AMB_BUF_REG, *PAMB_BUF_REG;

typedef struct _AMB_DATA_BUF {
	PVOID	pBuffer;
	ULONG	BufferSize;
	ULONG	Offset;
} AMB_DATA_BUF, *PAMB_DATA_BUF;
...
} AMB_CONFIGURATION, *PAMB_CONFIGURATION;
...
} AMB_TETR_IRQ, *PAMB_TETR_IRQ;

#pragma pack(pop)

#endif // _DDWAMBP_H_

// ****************** End of file ddWambp.h **********************
