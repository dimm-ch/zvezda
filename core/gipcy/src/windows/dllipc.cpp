...
#ifdef _UNICODE
GIPCY_API IPC_handle IPC_openLibraryEx(const IPC_str *baseName,
                                       unsigned param) {
  ...
  wcscpy(libname00, libname);
  //	if(libname[len_name-2] != '6' && libname[len_name-1] != '4')
  //	{
  //		wcscat(libname, L"64");
  wcscat(libname, L".dll");
  wcscat(libname0, L"64.dll");
  wcscat(libname00, L"-64.dll");
  //	}
