/*
 ## CyAPI C++ library header file (CyAPI.h)
*/
...
public:
    ...
    PUCHAR BeginDataXfer(PUCHAR buf, LONG len, OVERLAPPED *ov);
	//void AsyncXferCB(libusb_transfer* transfer, void* ov);
};
...
public:
    ...
    void        UsbdStatusString(ULONG stat, char* s);
...
private:
	...
	bool					isOpened;
	UINT32					nStopServThread;
	libusb_config_descriptor *hCfgDesc;
